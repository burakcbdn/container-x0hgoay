...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x0hgoay.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x0hgoay.containers.anotherwebservice.com/
...
```
git clone git@github.com:burakcbdn/container-x0hgoay.git
cd container-x0hgoay
```
...
```
docker attach container-x0hgoay
```
